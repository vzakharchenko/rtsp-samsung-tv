var Mpeg1Muxer,Mpeg1MuxerTcp, STREAM_MAGIC_BYTES, VideoStream, events, util, ws
...
Mpeg1MuxerTcp = require('./mpeg1muxerTcp')
...
VideoStream.prototype.startMpeg1Stream = function() {
  ...
  this.mpeg1Muxer = this.options.ffmpegOptions['-rtsp_transport'] === 'tcp'?
      new Mpeg1MuxerTcp({
